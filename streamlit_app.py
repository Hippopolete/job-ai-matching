...
with tab3:
    ...
    # 🔎 Show available columns in matches_df (optional for debugging)
    ...
    if selected_job:
        ...
        # Join with full candidate info
        merged_df = pd.merge(job_matches, candidates, left_on="Candidate Name", right_on="Candidate Name", how="left")
